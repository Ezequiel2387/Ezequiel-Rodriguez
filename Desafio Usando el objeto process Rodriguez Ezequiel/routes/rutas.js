...
const queryDelFork=require("../data/calculo")
...
router.get("/info", (req, res) => {
    ...
    console.log(obj)
    res.render("info", { layout: "main.hbs", data: obj })
})
...
router.get("/api/randoms", (req, res) => {
    ...
    let counttt=JSON.stringify(count)
    console.log(counttt)
    let calc = fork("./fork/calculo.js",[count]);
    calc.send(count);
    calc.on("message", (suma) => {
        res.send(suma)
    })
